...
function StatsCards({ activeSessionsCount, recentSessionsCount }) {
  return (
    <div className="lg:col-span-1 grid grid-cols-1 gap-6">
      {/* Active Count */}
      <div className="card bg-base-300 border-2 border-primary/20 hover:border-primary/40">
        <div className="card-body">
          <div className="flex items-center justify-between mb-3">
            <div className="p-3 bg-gradient-to-r from-purple-600 to-cyan-500 rounded-2xl">
              <UsersIcon className="w-7 h-7 text-white " />
            </div>
            <div className="badge bg-gradient-to-r from-purple-600 to-cyan-500">
              Live
            </div>
          </div>
      ...
      {/* Recent Count */}
      <div className="card bg-base-300 border-2 border-secondary/20 hover:border-secondary/40">
        <div className="card-body">
          <div className="flex items-center justify-between mb-3">
            <div className="p-3 bg-gradient-to-r from-purple-600 to-cyan-500 rounded-2xl">
