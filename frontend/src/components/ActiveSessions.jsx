...
function ActiveSessions({ sessions, isLoading, isUserInSession }) {
  return (
    <div className="lg:col-span-2 card bg-base-300 border-2 border-primary/20 hover:border-primary/30 h-full">
        ...
        <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-r from-purple-600 to-cyan-500 rounded-3xl flex items-center justify-center">
